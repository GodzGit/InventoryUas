...
<div class="container mt-4">
  <h4 class="fw-bold text-primary mb-3">📘 Judul View</h4>
    ...
    <a href="satuan.php" class="btn btn-primary btn-sm">Tampilkan Semua</a>
    <a href="satuan.php?filter=aktif" class="btn btn-success btn-sm">Hanya Aktif</a>
    <a href="satuan.php?filter=nonaktif" class="btn btn-secondary btn-sm">Hanya Tidak Aktif</a>
  </div>
  ...
  <div class="card shadow-sm border-0"><div class="card-body table-responsive">
    <table class="table table-bordered table-striped align-middle">
      <thead class="table-primary">
        <tr>
          <?php
          $result = mysqli_query($conn, "DESCRIBE v_master_satuan");
      ...
      // ambil parameter filter
        ...
        // dasar query
        $sql = "SELECT * FROM v_master_satuan";
